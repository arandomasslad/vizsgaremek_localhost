...
async function fetchCipok(gender) {
    try {
        ...
        for (let cipo of cipok) {
            ...
            const deleteButton = `<button class="btn btn-danger" onclick="deleteShoes('${id}')">DELETE</button>`;
            const modifyButton = `<button class="btn btn-warning" onclick="modifyCipo('${id}')">Módosítás</button>`;
...
function displaySearchResults(results) {
    ...
    results.forEach(result => {
        ...
        if (result.gender.toLowerCase() === genderFilter) {
            ...
            const deleteButton = `<button class="btn btn-danger" onclick="deleteShoes('${cipo._id}')">DELETE</button>`;
            const modifyButton = `<button class="btn btn-warning" onclick="modifyCipo('${cipo._id}')">Módosítás</button>`;
